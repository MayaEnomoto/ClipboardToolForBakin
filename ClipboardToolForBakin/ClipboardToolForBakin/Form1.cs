...
namespace ClipboardToolForBakin
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeDataGridSetting()
        {
            ...
            bool checkedState = toggleColumnsCheckBox.Checked;
            foreach (DataGridViewColumn column in dataGridView.Columns)
            {
                if (column.Name != "Tag" && column.Name != "Text" && column.Name != "Memo")
                {
                    column.Visible = checkedState;
                }
            }
        }
        ...
        private void toggleColumnsCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            bool checkedState = toggleColumnsCheckBox.Checked;
            foreach (DataGridViewColumn column in dataGridView.Columns)
            {
        ...
        private void contextMenuStrip_Opening(object sender, CancelEventArgs e)
        {
            ...
            pasteFromClipboardToolStripMenuItem.Enabled = hasYukar2ScriptCommandsFormatData;
        }
